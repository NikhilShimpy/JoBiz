...
class JRanjeetAnalysis extends StatefulWidget {
  const JRanjeetAnalysis({super.key});

  @override
  State<JRanjeetAnalysis> createState() => _SearchBarScreenState();
}

class _SearchBarScreenState extends State<JRanjeetAnalysis> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<List<QuerySnapshot<Object?>>?>(
        stream: FirebaseFirestore.instance.collection('RjobCard').snapshots().map((querySnapshot) => [querySnapshot]),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Jobs in Ranjeet Hanuman,Madhya Pradesh\n40 jobs',
