...
import 'package:find_your_job/OnboardingScreens/MessageScreen.dart';
...
class JAnyWhereInIndore extends StatefulWidget {
  const JAnyWhereInIndore({super.key});

  @override
  State<JAnyWhereInIndore> createState() => _SearchBarScreenState();
}

class _SearchBarScreenState extends State<JAnyWhereInIndore> {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<QuerySnapshot>>(
        stream: Rx.combineLatest3(
          ...
          FirebaseFirestore.instance.collection('RjobCard').snapshots(),
          FirebaseFirestore.instance.collection('GumastaNagarjobCard').snapshots(),
              (a, b, c) => [a, b, c],
        ),
        ...
        builder: (context, snapshot) {
          ...
          final List<QueryDocumentSnapshot> allJobCards = [];
